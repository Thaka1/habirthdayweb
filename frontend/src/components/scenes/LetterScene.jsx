...
const LetterScene = () => {
  ...
  return (
    <section className="min-h-screen px-6 pt-28 pb-28 flex flex-col items-center">
      ...
      <div className="relative w-full max-w-xl flex items-center justify-center" style={{ minHeight: '560px' }}>
        {/* Envelope (fades out when opened) */}
        <div
        ...
        {/* Letter card (scales up when opened) */}
        <div
