 ...
 * Owns UI; audio element lives in App.js (so it survives phase changes).
 */
const MusicPlayer = ({ audioRef, musicOn, setMusicOn }) => {
      ...
      >
        {expanded && (
          <div className="min-w-0">
            <p className="text-xs text-rose-500 uppercase tracking-widest">
              Now playing
            </p>
